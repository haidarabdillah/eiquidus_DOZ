...
exports.wallet = {
  ...
  host: '127.0.0.1',
  // port: The port # that the wallet is configured to listen for RPC requests on (default: 5555 for DOZ wallet)
  port: 5555,
...
exports.shared_pages = {
  ...
  //        Valid options: Cerulean, Cosmo, Cyborg, Darkly, DOZ, Flatly, Journal, Litera, Lumen, Lux, Materia, Minty, Morph, Pulse, Quartz, Sandstone, Simplex, Sketchy, Slate, Solar, Spacelab, Superhero, United, Vapor, Yeti, Zephyr
  ...
  page_title: 'Digital Ounce Explorer',
  ...
  page_header: {
    ...
    //                 NOTE: The path root is /public
    home_link_logo: '/img/header-logo128.png',
  ...
  page_footer: {
    ...
    powered_by_text:
      "<a class='nav-link poweredby' href='https://github.com/digitalis-uncia/digitalounce/eiquidus' target='_blank'>eIquidus Explorer v{explorer_version}</a>",
  },
};
...
exports.transaction_page = {
  ...
  genesis_tx:
    'dd1d332ad2d8d8f49195056d482ae3c96fd2d16e9d166413b27ca7f19775644c',
...
exports.richlist_page = {
  ...
  burned_coins: {
    ...
    addresses: ['DozBurnAddressXXXXXXXXXXXXXW7cDZQ'],
...
exports.api_page = {
  ...
  sample_data: {
    ...
    blockhash:
      '775d67da29dd6553268061f86368d06654944dd5d5c61db4c97e4c7960c11a74',
...
exports.loadSettings = function loadSettings() {
  ...
  if (fs.existsSync(settings_filename)) {
    try {
      ...
      console.warn(
        'The settings.json file is missing. Continuing using defaults.'
      );
    }
  } else
    console.warn(
  ...
  if (json_settings != null) {
    ...
    json_settings = fix_deprecated_setting(
      json_settings,
      'title',
      'shared_pages.page_title'
    );
    ...
    json_settings = fix_deprecated_setting(
      json_settings,
      'favicon',
      'shared_pages.favicon'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'homelink',
      'shared_pages.page_header.home_link'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'logoheight',
      'shared_pages.page_header.home_link_logo_height'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'sticky_header',
      'shared_pages.page_header.sticky_header'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'sticky_footer',
      'shared_pages.page_footer.sticky_footer'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'footer_height_desktop',
      'shared_pages.page_footer.footer_height_desktop'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'footer_height_tablet',
      'shared_pages.page_footer.footer_height_tablet'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'footer_height_mobile',
      'shared_pages.page_footer.footer_height_mobile'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'social_link_percent_height_desktop',
      'shared_pages.page_footer.social_link_percent_height_desktop'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'social_link_percent_height_tablet',
      'shared_pages.page_footer.social_link_percent_height_tablet'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'social_link_percent_height_mobile',
      'shared_pages.page_footer.social_link_percent_height_mobile'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'theme',
    ...
    json_settings = fix_deprecated_setting(
      json_settings,
      'display.markets',
      'markets_page.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'display.richlist',
      'richlist_page.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'display.search',
      'shared_pages.page_header.show_search'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'display.movement',
      'movement_page.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'display.network',
      'network_page.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'display.masternodes',
      'masternodes_page.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'display.masternodesdisplay.claim_address',
      'claim_address_page.enabledmasternodes_page.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'display.claim_address_header_menu',
      'claim_address_page.show_header_menu'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'display.page_header_bgcolor',
      'shared_pages.page_header.bgcolor'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'display.page_footer_bgcolor',
      'shared_pages.page_footer.bgcolor'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'display.table_header_bgcolor',
      'shared_pages.table_header_bgcolor'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'display.networkpnl',
      'shared_pages.page_header.panels.network_panel.display_order'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'display.difficultypnl',
      'shared_pages.page_header.panels.difficulty_panel.display_order'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'display.masternodespnl',
      'shared_pages.page_header.panels.masternodes_panel.display_order'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'display.coinsupplypnl',
      'shared_pages.page_header.panels.coin_supply_panel.display_order'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'display.pricepnl',
      'shared_pages.page_header.panels.price_panel.display_order'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'display.marketcappnl',
      'shared_pages.page_header.panels.market_cap_panel.display_order'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'display.logopnl',
      'shared_pages.page_header.panels.logo_panel.display_order'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'index.show_last_updated',
      'index_page.show_last_updated'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'index.show_hashrate',
      'shared_pages.show_hashrate'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'index.difficulty',
      'shared_pages.difficulty'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'index.last_txs',
      'api_page.public_apis.ext.getlasttxs.max_items_per_query'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'reward_page.show_last_updated',
      'blockchain_specific.heavycoin.reward_page.show_last_updated'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'api.blockindex',
      'api_page.sample_data.blockindex'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'api.blockhash',
      'api_page.sample_data.blockhash'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'api.txhash',
      'api_page.sample_data.txhash'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'api.address',
      'api_page.sample_data.address'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'markets.default',
      'markets_page.default_exchange.exchange_name'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'markets.market_dropdown_menu',
      'markets_page.show_market_dropdown_menu'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'markets.market_select_visible',
      'markets_page.show_market_select'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'richlist.distribution',
      'richlist_page.wealth_distribution.show_distribution_chart'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'richlist.received',
      'richlist_page.show_received_coins'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'richlist.balance',
      'richlist_page.show_current_balance'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'movement.min_amount',
      'movement_page.movement_table.min_amount'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'movement.low_flag',
      'movement_page.movement_table.low_warning_flag'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'movement.high_flag',
      'movement_page.movement_table.high_warning_flag'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'genesis_tx',
      'transaction_page.genesis_tx'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'genesis_block',
      'block_page.genesis_block'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'heavy',
      'blockchain_specific.heavycoin.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'save_stats_after_sync_blocks',
      'sync.save_stats_after_sync_blocks'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'txcount',
      'api_page.public_apis.ext.getaddresstxs.max_items_per_query'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'txcount_per_page',
      'address_page.history_table.items_per_page'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'show_sent_received',
      'address_page.show_sent_received'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'supply',
    ...
    json_settings = fix_deprecated_setting(
      json_settings,
      'nethash',
      'shared_pages.page_header.panels.network_panel.nethash'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'nethash_units',
      'shared_pages.page_header.panels.network_panel.nethash_units'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'usecors',
      'webserver.cors.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'corsorigin',
      'webserver.cors.corsorigin'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.rpc.getdifficulty',
      'api_page.public_apis.rpc.getdifficulty.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.rpc.getconnectioncount',
      'api_page.public_apis.rpc.getconnectioncount.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.rpc.getblockcount',
      'api_page.public_apis.rpc.getblockcount.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.rpc.getblockhash',
      'api_page.public_apis.rpc.getblockhash.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.rpc.getblock',
      'api_page.public_apis.rpc.getblock.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.rpc.getrawtransaction',
      'api_page.public_apis.rpc.getrawtransaction.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.rpc.getnetworkhashps',
      'api_page.public_apis.rpc.getnetworkhashps.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.rpc.getvotelist',
      'api_page.public_apis.rpc.getvotelist.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.rpc.getmasternodecount',
      'api_page.public_apis.rpc.getmasternodecount.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.rpc.getmaxmoney',
      'blockchain_specific.heavycoin.public_apis.getmaxmoney.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.rpc.getmaxvote',
      'blockchain_specific.heavycoin.public_apis.getmaxvote.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.rpc.getvote',
      'blockchain_specific.heavycoin.public_apis.getvote.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.rpc.getphase',
      'blockchain_specific.heavycoin.public_apis.getphase.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.rpc.getreward',
      'blockchain_specific.heavycoin.public_apis.getreward.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.rpc.getsupply',
      'blockchain_specific.heavycoin.public_apis.getsupply.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.rpc.getnextrewardestimate',
      'blockchain_specific.heavycoin.public_apis.getnextrewardestimate.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.rpc.getnextrewardwhenstr',
      'blockchain_specific.heavycoin.public_apis.getnextrewardwhenstr.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.ext.getmoneysupply',
      'api_page.public_apis.ext.getmoneysupply.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.ext.getdistribution',
      'api_page.public_apis.ext.getdistribution.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.ext.getaddress',
      'api_page.public_apis.ext.getaddress.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.ext.getaddresstxs',
      'api_page.public_apis.ext.getaddresstxs.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.ext.gettx',
      'api_page.public_apis.ext.gettx.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.ext.getbalance',
      'api_page.public_apis.ext.getbalance.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.ext.getlasttxs',
      'api_page.public_apis.ext.getlasttxs.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.ext.getcurrentprice',
      'api_page.public_apis.ext.getcurrentprice.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.ext.getbasicstats',
      'api_page.public_apis.ext.getbasicstats.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.ext.getsummary',
      'api_page.public_apis.ext.getsummary.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.ext.getnetworkpeers',
      'api_page.public_apis.ext.getnetworkpeers.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.ext.getmasternodelist',
      'api_page.public_apis.ext.getmasternodelist.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.ext.getmasternoderewards',
      'api_page.public_apis.ext.getmasternoderewards.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'public_api.ext.getmasternoderewardstotal',
      'api_page.public_apis.ext.getmasternoderewardstotal.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'api_cmds.heavies.getmaxmoney',
      'blockchain_specific.heavycoin.api_cmds.getmaxmoney'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'api_cmds.heavies.getmaxvote',
      'blockchain_specific.heavycoin.api_cmds.getmaxvote'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'api_cmds.heavies.getvote',
      'blockchain_specific.heavycoin.api_cmds.getvote'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'api_cmds.heavies.getphase',
      'blockchain_specific.heavycoin.api_cmds.getphase'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'api_cmds.heavies.getreward',
      'blockchain_specific.heavycoin.api_cmds.getreward'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'api_cmds.heavies.getnextrewardestimate',
      'blockchain_specific.heavycoin.api_cmds.getnextrewardestimate'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'api_cmds.heavies.getnextrewardwhenstr',
      'blockchain_specific.heavycoin.api_cmds.getnextrewardwhenstr'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'api_cmds.heavies.getsupply',
      'blockchain_specific.heavycoin.api_cmds.getsupply'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'api_cmds.masternode_count',
      'api_cmds.getmasternodecount'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'wallet.user',
    ...
    json_settings = fix_deprecated_setting(
      json_settings,
      'social_links',
      'shared_pages.page_footer.social_links'
    );
    // fix old deprecated settings from v1.99
    json_settings = fix_deprecated_setting(
      json_settings,
      'shared_pages.page_header.show_search',
      'shared_pages.page_header.search.enabled'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'index_page.show_last_updated',
      'index_page.page_header.show_last_updated'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'masternodes_page.show_last_updated',
      'masternodes_page.page_header.show_last_updated'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'movement_page.show_last_updated',
      'movement_page.page_header.show_last_updated'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'network_page.show_last_updated',
      'network_page.page_header.show_last_updated'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'richlist_page.show_last_updated',
      'richlist_page.page_header.show_last_updated'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'markets_page.show_last_updated',
      'markets_page.page_header.show_last_updated'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'blockchain_specific.heavycoin.reward_page.show_last_updated',
      'blockchain_specific.heavycoin.reward_page.page_header.show_last_updated'
    );
    ...
    if (json_settings.shared_pages.page_footer.social_links != null) {
      ...
      json_settings.shared_pages.page_footer.social_links.forEach(function (
        social_link
      ) {
    ...
    if (
      json_settings.index != null &&
      json_settings.index.txs_per_page != null
    ) {
      // fix parent elements to be sure there are no missing parents
      json_settings = ensure_parent_elements_exist(
        json_settings,
        'index_page.transaction_table.items_per_page'
      );
      json_settings = ensure_parent_elements_exist(
        json_settings,
        'movement_page.movement_table.items_per_page'
      );
      // copy old setting to new index setting
      json_settings.index_page.transaction_table.items_per_page =
        json_settings.index.txs_per_page;
      // copy old setting to new movement setting
      json_settings.movement_page.movement_table.items_per_page =
        json_settings.index.txs_per_page;
      // delete old setting
    ...
    json_settings = ensure_parent_elements_exist(
      json_settings,
      'richlist_page.burned_coins.addresses'
    );
    ...
    if (json_settings.burned_coins != null) {
      ...
      json_settings.burned_coins.forEach(function (address) {
        ...
        json_settings.richlist_page.burned_coins.addresses.push(
          address.address
        );
      });
      // delete old setting
    ...
    if (json_settings.github != null) {
      ...
      json_settings.shared_pages.page_footer.social_links.push({
        enabled:
          json_settings.display == null || json_settings.display.github == null
            ? false
            : json_settings.display.github,
        tooltip_text: 'Github',
    ...
    if (json_settings.discord != null) {
      ...
      json_settings.shared_pages.page_footer.social_links.push({
        enabled:
          json_settings.display == null || json_settings.display.discord == null
            ? false
            : json_settings.display.discord,
    ...
    if (json_settings.telegram != null) {
      ...
      json_settings.shared_pages.page_footer.social_links.push({
        enabled:
          json_settings.display == null ||
          json_settings.display.telegram == null
            ? false
            : json_settings.display.telegram,
    ...
    if (json_settings.reddit != null) {
      ...
      json_settings.shared_pages.page_footer.social_links.push({
        enabled:
          json_settings.display == null || json_settings.display.reddit == null
            ? false
            : json_settings.display.reddit,
        tooltip_text: 'Reddit',
    ...
    if (json_settings.youtube != null) {
      ...
      json_settings.shared_pages.page_footer.social_links.push({
        enabled:
          json_settings.display == null || json_settings.display.youtube == null
            ? false
            : json_settings.display.youtube,
    ...
    if (json_settings.slack != null) {
      ...
      json_settings.shared_pages.page_footer.social_links.push({
        enabled:
          json_settings.display == null || json_settings.display.slack == null
            ? false
            : json_settings.display.slack,
        tooltip_text: 'Slack',
    ...
    if (json_settings.twitter != null) {
      ...
      json_settings.shared_pages.page_footer.social_links.push({
        enabled:
          json_settings.display == null || json_settings.display.twitter == null
            ? false
            : json_settings.display.twitter,
    ...
    if (json_settings.facebook != null) {
      ...
      json_settings.shared_pages.page_footer.social_links.push({
        enabled:
          json_settings.display == null ||
          json_settings.display.facebook == null
            ? false
            : json_settings.display.facebook,
    ...
    if (json_settings.googleplus != null) {
      ...
      json_settings.shared_pages.page_footer.social_links.push({
        enabled:
          json_settings.display == null ||
          json_settings.display.googleplus == null
            ? false
            : json_settings.display.googleplus,
        tooltip_text: 'Google+',
    ...
    if (json_settings.bitcointalk != null) {
      ...
      json_settings.shared_pages.page_footer.social_links.push({
        enabled:
          json_settings.display == null ||
          json_settings.display.bitcointalk == null
            ? false
            : json_settings.display.bitcointalk,
        tooltip_text: 'Bitcointalk',
        url:
          'https://bitcointalk.org/index.php?topic=' +
          json_settings.bitcointalk,
        fontawesome_class: 'fa-brands fa-eth',
        image_path: '',
      });
      // delete old settings
    ...
    if (json_settings.website != null) {
      ...
      json_settings.shared_pages.page_footer.social_links.push({
        enabled:
          json_settings.display == null || json_settings.display.website == null
            ? false
            : json_settings.display.website,
    ...
    if (
      json_settings.markets != null &&
      json_settings.markets.enabled != null
    ) {
      ...
      json_settings.markets.enabled.forEach(function (market) {
        ...
        json_settings = ensure_parent_elements_exist(
          json_settings,
          'markets_page.exchanges.' + market + '.enabled'
        );
        ...
        if (
          json_settings.markets.coin != null &&
          json_settings.markets.exchange != null
        ) {
          // set the new setting trading_pairs
          json_settings.markets_page.exchanges[market].trading_pairs = [
            json_settings.markets.coin + '/' + json_settings.markets.exchange,
          ];
          // check if the default exchange trading pair is set
          if (
            json_settings.markets_page.default_exchange.trading_pair == null
          ) {
            // fix parent elements to be sure there are no missing parents
            json_settings = ensure_parent_elements_exist(
              json_settings,
              'markets_page.default_exchange.trading_pair'
            );
            // set the default exchange trading pair
            json_settings.markets_page.default_exchange.trading_pair =
              json_settings.markets.coin + '/' + json_settings.markets.exchange;
          }
        }
      });
    ...
    if (Object.byString(json_settings, 'address') != null)
      delete json_settings.address;
    if (Object.byString(json_settings, 'display') != null)
      delete json_settings.display;
    if (Object.byString(json_settings, 'index') != null)
      delete json_settings.index;
    if (Object.byString(json_settings, 'api') != null) delete json_settings.api;
    if (Object.byString(json_settings, 'markets') != null)
      delete json_settings.markets;
    if (Object.byString(json_settings, 'richlist') != null)
      delete json_settings.richlist;
    if (Object.byString(json_settings, 'movement') != null)
      delete json_settings.movement;

    // fix old deprecated settings from v1.100
    if (
      json_settings.shared_pages.favicons == null &&
      json_settings.shared_pages.favicon != null &&
      fs.existsSync(json_settings.shared_pages.favicon)
    ) {
      ...
      json_settings = fix_deprecated_setting(
        json_settings,
        'shared_pages.favicon',
        'shared_pages.favicons.favicon32'
      );
    ...
    json_settings = fix_deprecated_setting(
      json_settings,
      'shared_pages.page_header.network_charts.difficulty_chart.line_color',
      'shared_pages.page_header.network_charts.difficulty_chart.pow_line_color'
    );
    json_settings = fix_deprecated_setting(
      json_settings,
      'shared_pages.page_header.network_charts.difficulty_chart.fill_color',
      'shared_pages.page_header.network_charts.difficulty_chart.pow_fill_color'
    );
  ...
  if (Object.byString(json_settings, old_path) != null) {
    ...
    if (Object.byString(json_settings, new_path) == null) {
      ...
      console.warn(
        "Deprecated setting '" +
          old_path +
          "' has been mapped to the new location '" +
          new_path +
          "'. Be sure to make this change in settings.json as the old setting will be removed in a future release."
      );
    }
  }
  ...
  if (typeof current_setting === 'object' && current_setting !== null) {
    ...
    if (Object.byString(exports, path) == null) {
      ...
      console.warn(
        "Unknown setting '" +
          path +
          "' has been ignored. This setting doesn't exist or was removed."
      );
    } else {
      ...
      if (Array.isArray(current_setting) || exceptions.indexOf(path) > -1) {
        ...
        eval(
          'exports' +
            fix_object_path(path) +
            ' = ' +
            JSON.stringify(Object.byString(json_settings, path))
        );
      } else {
...
check_missing_settings = function (
  json_settings,
  exceptions,
  current_setting,
  path
  ...
  if (typeof current_setting === 'object' && current_setting !== null) {
    ...
    if (Object.byString(json_settings, path) == null) {
      ...
      if (exceptions.indexOf(path) == -1) {
        ...
        // show warning msg
        console.warn(
          "setting '" + path + "' is missing. Loading default value."
        );
      }
    } else {
...
Object.byString = function (o, s) {
  ...
  for (var i = 0, n = a.length; i < n; ++i) {
    var k = a[i];
    if (typeof o === 'object' && o !== null && k in o) o = o[k];
    else return;
  }
  return o;
};
